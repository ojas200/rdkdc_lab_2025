function gst = ur5FwdKin(q)
    ...
    xi2 = RevoluteTwistSkew([0;0;L0],e2);
    xi3 = RevoluteTwistSkew([0;0;L0+L1],e2);
    xi4 = RevoluteTwistSkew([0;0;L0+L1+L2],e2);
    xi5 = RevoluteTwistSkew([0;L3;0],e3);%Unchanged
    xi6 = RevoluteTwistSkew([0;0;L0+L1+L2+L4],e2);
